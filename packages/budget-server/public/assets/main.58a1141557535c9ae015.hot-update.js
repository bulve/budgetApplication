    ...
    createBudget(userPayload, budgetDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.budgetRepository.save(budget)
                .then(createdBudget => response_entity_1.ResponseEntityFor.successWith(`Budget created succesfuly`))
                .catch(error => response_entity_1.ResponseEntityFor.failureWith(`Failed to create budget with: ${error}`));
        });
    }
...
//# sourceMappingURL=main.58a1141557535c9ae015.hot-update.js.map