    ...
    updatePassword(userName, oldPassword, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.userRepository.findOne({ userName })
                ...
                .then(user => response_entity_1.ResponseEntityFor.successWith(`User '${userName}' password updated successfuly`))
                .catch(error => response_entity_1.ResponseEntityFor.failureWith(error.message));
        });
    }
    getUser(userName) {
...
//# sourceMappingURL=main.40ec8f421e600362d4e6.hot-update.js.map