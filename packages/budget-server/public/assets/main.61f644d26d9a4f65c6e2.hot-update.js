        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.budgetRepository.findOne(budgetId)
                ...
                if (budget.userId == userPayload.userId) {
                    ...
                    console.log("error ");
                    throw new Error(`User does not have Budget by id '${budgetId}' and cannot perform actions`);
                }
            })
                .then(budget => {
                if (this.canActionBePerfomed(action, budget)) {
                    ...
                    console.log("error 2");
                    throw new Error(`Action '${action.type}' cannot be perfomed to Budget '${budget.name}'`);
                }
            })
...
//# sourceMappingURL=main.61f644d26d9a4f65c6e2.hot-update.js.map