        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.getBudgetsByUserId(userPayload.userId)
                ...
                if (budgetsById.length > 1) {
                    ...
                    throw Error(`User does not have Budget by id '${budgetId}' and cannot perform action`);
                }
            })
                .then(budget => {
                ...
                .then(action => response_entity_1.ResponseEntityFor.successWith(`Action '${action.type}' where perfomed on Budget by id '${budgetId}'`))
...
//# sourceMappingURL=main.2a149d96b6dfeeaa3340.hot-update.js.map