        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.findOne({ userName })
                ...
                if (user) {
                    ...
                    return response_entity_1.ResponseEntityFor.successWith(`User '${userName}' updated successfuly`);
                }
                throw Error(`User '${userName}' does not exist.`);
            })
                .then(user => response_entity_1.ResponseEntityFor.successWith())
                .catch(error => response_entity_1.ResponseEntityFor.failureWith(error.message));
        });
    }
            ...
            return this.userRepository.findOne({ userName })
                ...
                if (user) {
                    if (pasword_hashing_service_1.comparePasswordsSync(oldPassword, user.password)) {
                        ...
                        ;
                        return response_entity_1.ResponseEntityFor.successWith(`User '${userName}' password updated successfuly`);
                    }
...
//# sourceMappingURL=main.39ff84d045130124277f.hot-update.js.map