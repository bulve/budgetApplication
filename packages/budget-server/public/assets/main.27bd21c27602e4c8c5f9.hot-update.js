...
throw new Error("Module parse failed: The keyword 'yield' is reserved (56:12)\nYou may need an appropriate loader to handle this file type.\n| updateUser(userDTO, user_entity_1.UserDTO, userName, string);\r\n| Promise < response_entity_1.ResponseEntity > {\r\n>     return: yield this.userRepository.findOne({ userName })\r\n|         .then(user => {\r\n|         if (user) {\r");

/***/ })

};
//# sourceMappingURL=main.27bd21c27602e4c8c5f9.hot-update.js.map