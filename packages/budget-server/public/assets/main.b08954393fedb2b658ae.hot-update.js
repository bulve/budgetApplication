    ...
    login(loginRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.userService.getUser(loginRequest.userName)
                ...
                .then(payload => response_entity_1.ResponseEntityFor.successWith({ access_token: this.jwtService.sign(payload) }))
...
//# sourceMappingURL=main.b08954393fedb2b658ae.hot-update.js.map