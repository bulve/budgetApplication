        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.budgetRepository.findOne(budgetId)
                ...
                if (budget.userId == userPayload.userId) {
                    ...
                    throw `User does not have Budget by id '${budgetId}' and cannot perform actions`;
                }
            })
                .then(budget => {
                if (this.canActionBePerfomed(action, budget)) {
                    ...
                    throw `Action '${action.type}' cannot be perfomed to Budget '${budget.name}'`;
                }
            })
...
//# sourceMappingURL=main.9d849c8e4fdcde8f7d42.hot-update.js.map