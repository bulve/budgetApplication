...
export interface IAccountService {
    ...
    createAccount(userPayload: IUserPayload, accountRequest: IAccountRequest): Promise<IServiceResponse<string>>;
    ...
    performAction(userPayload: IUserPayload, action: IAction, accountId: string): Promise<IServiceResponse<string>>;
}